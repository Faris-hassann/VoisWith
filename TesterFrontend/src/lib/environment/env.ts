...
const envSchema = z.object({
  ...
  NEXT_PUBLIC_TEST_RUNS_ENDPOINT: z.string().startsWith("/").default("/api/v1/testing/runs"),
...
const parsed = envSchema.parse({
  ...
  NEXT_PUBLIC_TEST_RUNS_ENDPOINT: process.env.NEXT_PUBLIC_TEST_RUNS_ENDPOINT,
...
export const env = {
  ...
  testRunsEndpoint: parsed.NEXT_PUBLIC_TEST_RUNS_ENDPOINT,
