...
export const openApiDocument = {
  ...
  components: {
    ...
    schemas: {
      ...
      Issue: {
        type: "object",
        required: ["id", "severity", "title", "description", "evidence", "confidence"],
        properties: {
          id: { type: "string" },
          ...
          failedTestCount: { type: "integer", minimum: 1 },
          affectedPages: { type: "array", items: { type: "string" } },
          relatedTestTypes: { type: "array", items: { type: "string", enum: TEST_TYPES } },
          pageUrl: { type: "string" },
          role: { type: "string" },
          viewport: { type: "string" },
          locale: { type: "string" },
