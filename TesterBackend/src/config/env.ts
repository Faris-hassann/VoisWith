...
const envSchema = z.object({
  ...
  MAX_PAGES_PER_RUN: numberFromEnv.default("5"),
  MAX_DEPTH_PER_RUN: numberFromEnv.default("5"),
  MAX_ACTIONS_PER_PAGE: numberFromEnv.default("15"),
  MAX_RUN_DURATION_SECONDS: numberFromEnv.default("300"),
  MAX_AI_CALLS_PER_RUN: numberFromEnv.default("8"),
  MAX_OPENROUTER_CALLS_PER_RUN: numberFromEnv.default("8"),
