...
function contextFor(): RunContext {
  ...
  return {
    ...
    diagnostics: {
      ...
      pages: [],
      ai: { calls: 999, maxCalls: 999, disabled: false, openRouterConfigured: true, modelConfigured: true, successes: 0, failures: [], validationFailures: [], maxTestCases: 400, testCasesGenerated: 0, testCasesDropped: 0, deterministicFallbacks: 0 },
    },
  };
}
