...
function contextFor(overrides: { maxDepth?: number; maxPages?: number }): RunContext {
  return {
    ...
    diagnostics: {
      ...
      pages: [],
      ai: { calls: 0, maxCalls: 25, disabled: false, openRouterConfigured: false, modelConfigured: false, successes: 0, failures: [], validationFailures: [], maxTestCases: 400, testCasesGenerated: 0, testCasesDropped: 0, deterministicFallbacks: 0 },
    },
  };
}
